...
const Default = ({ className, ...props }) => <LoaderIcon className={cn('animate-spin', className)} {...props} />;

const Circle = ({ className, ...props }) => <LoaderCircleIcon className={cn('animate-spin', className)} {...props} />;

const Pinwheel = ({ className, ...props }) => <LoaderPinwheelIcon className={cn('animate-spin', className)} {...props} />;
